    ...
    public function render(): string {
        ...
        <body class="h-full">
            ...
            <div class="flex min-h-[calc(100vh-74px)]">
                ...
                <!-- Styles additionnels pour la gestion des enseignants -->
                <style>
                    * {
                        margin: 0;
                        padding: 0;
                ...
                <!-- Main Content : Gestion des enseignants (issue de la première interface) -->
                    ...
                    <div class="dashboard">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2 ps-2">
                            <div>
                                <h1 class="display-6 fw-semibold d-flex gap-2 align-items-center" style="color: #0f172a;">
                                    <i class="bi bi-people "></i> <span class="fs-4 text-gray-900">Enseignants</span>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-2">
                            ...
                            <div class="bg-white rounded-2xl shadow-sm p-4 sm:p-6 border border-gray-100 hover-lift stat-card">
                                <div class="flex justify-between items-start">
                                    <div>
                                        <p class="text-gray-500 text-sm text-uppercase">Permanents</p>
                            ...
                            <div class="bg-white rounded-2xl shadow-sm p-4 sm:p-6 border border-gray-100 hover-lift stat-card">
                                <div class="flex justify-between items-start">
                                    <div>
                                        <p class="text-gray-500 text-sm text-uppercase">Vacataires</p>
                                        <p class="text-2xl font-bold text-gray-800 mt-1">0</p>
                                    </div>
                                    <div class="py-2.5 px-2.5 bg-green-500  rounded-3">
                                        <i class="bi bi-person-up  text-white text-xl"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-white rounded-2xl shadow-sm p-4 sm:p-6 border border-gray-100 hover-lift stat-card">
                                <div class="flex justify-between items-start">
                                    <div>
                                        <p class="text-gray-500 text-sm text-uppercase">Volume horaire</p>
                                        <p class="text-2xl font-bold text-gray-800 mt-1">1248h</p>
                                    </div>
                        ...
                        <div class="row g-3 mb-5">
                            <div class="col-lg-6">
                                <div class="search-wrapper d-flex align-items-center">
                                    ...
                                    <input type="text" class="form-control search-input" placeholder="Rechercher un enseignant, département...">
                                        ...
                                        <div class="teacher-card bg-white">
                                            <div class="d-flex align-items-start gap-3 mb-3">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="text-secondary small mb-1">
                                                        <span>cours: javascript</span>
                                                    </div>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <i class="bi bi-building fs-7 text-secondary"></i>
                                                        <span class="small" style="color: #334155;">Mathématiques</span>
                                            ...
                                            <div class="d-flex flex-wrap gap-3 mb-3">
                                                <div class="d-flex align-items-center gap-1">
                                                    ...
                                                    <span class="small" style="color: #475569;">jean@gmail.com</span>
                                                </div>
                            ...
                            <div class="col-xl-4">
                                <div class="sidebar-premium">
                                    ...
                                    <div class="search-wrapper d-flex align-items-center mb-4 w-100">
                                        <i class="bi bi-search text-secondary me-2"></i>
                                        <input type="text" class="form-control search-input" placeholder="Recherche rapide...">
                                        <span class="badge bg-light text-secondary px-3 py-2 rounded-5">⌘K</span>
                                    </div>
                                    ...
                                    <div class="list-group list-group-flush mb-4">
                                        ...
                                        foreach ($depts as $nom => $nb): ?>
                                        <div class="list-group-item border-0 px-0 py-1 d-flex justify-content-between align-items-center bg-transparent">
                                            <div>
                                                <input class="form-check-input me-2" type="checkbox" id="dept<?php echo $nom; ?>" <?php echo $nom == 'Tous' ? 'checked' : ''; ?>>
                                                <label class="form-check-label" for="dept<?php echo $nom; ?>"><?php echo $nom; ?></label>
                                            </div>
                                            <span class="badge bg-light text-dark rounded-pill"><?php echo $nb; ?></span>
                                        </div>
                                        <?php endforeach; ?>
                                        <div class="mt-2">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <span class="badge-vacataire">Vacataire</span>
                                            <span class="fw-semibold">13</span>
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <span class="badge-doctorant">Doctorant</span>
                                            <span class="fw-semibold">4</span>
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span class="badge-emerite">Émérite</span>
