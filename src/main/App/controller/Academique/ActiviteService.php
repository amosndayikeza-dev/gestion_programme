...
<?php
    ...
    $pathActiviteService = str_replace("\\","/", __DIR__ . '/../../service/Academique/ActiviteService.php');
    $pathActivite = str_replace("\\","/", __DIR__ . '/../../model/Academique/Activite.php');

    require_once  $pathActiviteService; 
    require_once  $pathActivite; 
